...
define([
    ...
    "dojo/number",
    "dijit/popup",
    "dojo/text!./templates/SecondGrid.html",
    "dijit/TooltipDialog",
    "dijit/form/CheckBox",
    ...
    var t = declare("widgets.SecondGrid",_Widget,{
        ...
        _setEvent:function(){
            ...
            on(this._opacityTextBox,"change",lang.hitch(this,function(e){
                var layer = this.map.getLayer("secondGrid");
                var labelLayer = this.map.getLayer("secondGridlabels");
        ...
        _setSecondGridLayer:function(){
            this._secondGridlayer = this.map.getLayer("secondGrid");
            this._secondGridlayer.on("click", lang.hitch(this, function (evt) {
                this._mapPoint = evt.mapPoint;
                topic.publish(this.domNode.id + "click", this._mapPoint, this._toolTipDialog);
                xhr.post(this._projectName + "/widgets/handler/SecondGrid.ashx", {
                    handleAs: "text",
                    timeout: 10000,
                    data: {
