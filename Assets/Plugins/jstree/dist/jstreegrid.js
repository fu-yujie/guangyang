		...
		this._initialize = function () {
			if (!this._initialized) {
				...
				if (!styled) {
					styled = true;
					styles = [
						'.jstree-grid-cell {vertical-align: top; line-height:36px; overflow:hidden;margin-left:0;position:relative;width: 100%;white-space: nowrap;}',
						'.jstree-grid-cell span { margin-left:5px; margin-right:0px;margin-right:0px;*display:inline;*+display:inline;white-space: nowrap;}',
						...
						'.jstree-grid-header-cell {overflow: hidden; white-space: nowrap; height:26px; padding:6px 0;}',
						'.jstree-grid-header-themeroller {border: 0; padding: 1px 3px;}',
						'.jstree-grid-header-regular {background-color: #f8f8f8; line-height:26px; padding-left:6px; color:#333; font-size:13px; font-weight:700;}',
						'.jstree-grid-resizable-separator {cursor: col-resize;}',
						'.jstree-grid-separator-regular {/*border-color: #d0d0d0; border-style: solid;*/ border-top:1px solid #deeffb;}',
